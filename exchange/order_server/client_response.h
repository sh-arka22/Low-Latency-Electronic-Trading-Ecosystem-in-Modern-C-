...
#pragma pack(push, 1)
  ...
  /// Matching Engine thread -> Order Gateway Server thread.
  /// client_order_id_ is what the client sent; market_order_id_ is the unique
  /// id assigned by the matching engine.
  ...
  /// TCP wire format = per-client sequence number + MEClientResponse.
