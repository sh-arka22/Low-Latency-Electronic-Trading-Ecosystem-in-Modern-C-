...
namespace Trading {
  ...
  class TradeEngine;   // defined in Ch10 — forward declared to break cycle

  class OrderManager {
  public:
    OrderManager(Common::Logger *logger,
    ...
    auto newOrder(OMOrder *order, TickerId ticker_id, Price price,
